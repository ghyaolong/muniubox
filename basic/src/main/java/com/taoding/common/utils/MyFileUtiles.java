...
public class MyFileUtiles {

    private static Logger logger = Logger.getLogger(MyFileUtiles.class);
...
//        boolean bool = MyFileUtiles.isAllowSize(560450);
