...
public class VoucherTwoPdf_14 extends VoucherTwoPdf {
	
	private final static float BINDING_HEIHGT = 396;

	VoucherTwoPdf_14(String dest, List<CpaVoucher> data) throws IOException {
		super(dest, data);
		HEIGHT_01 = 25;
		HEIGHT_02 = 40;
		CONTENT_HEADER_CELL = new Cell()
				.setFontSize(FontSize.FONT_SIZE_8)
				.setBold()
